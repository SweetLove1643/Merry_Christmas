...
function createGift() {
  ...
  const messages = [
    ...
    '🎅 Ho Ho Ho! Bất ngờ chưa',
    '🎅 Ho Ho Ho! Ước đi con cờ hó',
    '🎁 Bạn vừa nhận được một món quà đặc biệt!',
    '🎄 Giáng sinh này có một món quà ngọt ngào cho bạn!',
    '🎅 Ông già Noel đã gửi lời chúc đến bạn!',
    '⭐ Chúc bạn một mùa lễ hội vui vẻ và hạnh phúc!',
    ...
    '🎁 Chúc bạn có một mùa Giáng sinh tuyệt vời!',
    '🎅 Tận hưởng mùa lễ hội với đầy ắp yêu thương!',
    '🍭 Món quà ngọt ngào đang chờ bạn!',
    '❄️ Mùa đông lạnh giá, nhưng bạn sẽ luôn ấm áp!',
    '🎉 Bất ngờ đã đến! Chúc mừng Giáng sinh!',
    '🌟 Cầu mong cho bạn một năm mới rực rỡ!',
    '🎁 Một bất ngờ cực lớn đang chờ bạn!',
    '🎄 Chúc bạn một mùa lễ Giáng sinh an lành!',
    '🧸 Ông già Noel mang đến cho bạn một món quà dễ thương!',
    '🌟 Thắp sáng niềm vui trong mùa lễ hội!',
    '🦄 Một món quà đầy phép màu đang đến!',
    '🎅 Ho Ho Ho! Quà bất ngờ từ ông già Noel!',
    '💖 Cảm ơn bạn đã luôn bên cạnh! Chúc bạn hạnh phúc!',
  ];
